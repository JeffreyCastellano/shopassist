...
/*
    ...
    public void onRestoreInstanceState(Parcelable state) {
        ...
        mPrevScrolledChildrenHeight = ss.prevFirstVisiblePosition;
        mPrevScrollY = ss.prevScrollY;
        mScrollY = ss.scrollY;
        mChildrenHeights = ss.childrenHeights;
        Log.d("TAG","RESOTRE INS !!!!!"+ ss.childrenHeights);
        Log.d("TAG","RESOTRE INS !!!!!"+ ss.prevFirstVisiblePosition);
        Log.d("TAG","RESOTRE INS !!!!!"+ ss.prevFirstVisibleChildHeight);
        Log.d("TAG","RESOTRE INS !!!!!"+ ss.prevScrollY);
        Log.d("TAG","RESOTRE INS !!!!!"+ ss.scrollY);
    ...
    public Parcelable onSaveInstanceState() {
        Log.d("TAG","ON SAVEINS !!!!!"+mPrevFirstVisiblePosition);
        Log.d("TAG","ON SAVEINS !!!!!"+mPrevFirstVisibleChildHeight);
        Log.d("TAG","ON SAVEINS !!!!!"+mPrevScrolledChildrenHeight);
        Log.d("TAG","ON SAVEINS !!!!!"+mPrevScrollY);
